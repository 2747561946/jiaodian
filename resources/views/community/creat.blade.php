...
<html>
    ...
    <body>
        <div class="x-body">
            ...
            <form action="{{ route('communitystore') }}" class="layui-form layui-form-pane" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">&nbsp;
                        ...
                        <td><input class="preview" name="logo" id="" type="file"></td>
                    </div>
                </div>
