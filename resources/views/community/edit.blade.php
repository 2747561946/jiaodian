...
<html>
    ...
    <body>
        <div class="x-body">
            <form action="{{ route('communityupdate',['id'=>$community->id]) }}"  class="layui-form layui-form-pane" method="post" enctype="multipart/form-data">
            @csrf
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="{{$community->title}}" id="L_title" name="title" required lay-verify="title"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">&nbsp;
                        ...
                        <td><input class="preview" value="/upload/{{$community->logo}}" name="logo" id="" type="file"></td>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <div class="layui-input-block">
                        <textarea id="L_content" name="content" 
                        placeholder="请输入内容" class="layui-textarea fly-editor" style="height: 260px;">{{$community->content}}</textarea>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <input class="layui-btn" lay-filter="add" type="submit" value="立即发表">
                </div>
            </form>
        </div>
